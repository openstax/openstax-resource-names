...
import { fileSystemUnversionedDocumentStore } from '@openstax/ts-utils/services/documentStore/unversioned/file-system';
...
const services = {
  ...
  unversionedDocumentStore: fileSystemUnversionedDocumentStore({dataDir}),
